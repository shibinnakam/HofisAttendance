        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ActionChip(
                  avatar: const Icon(Icons.cloud_done_rounded, size: 16, color: Color(0xFF10B981)),
                  label: const Text('Render Cloud (hofisattendance)',
                      style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Color(0xFF6EE7B7))),
                  backgroundColor: const Color(0xFF10B981).withValues(alpha: 0.15),
                  side: BorderSide(color: const Color(0xFF10B981).withValues(alpha: 0.4)),
                  onPressed: () => _setPreset('https://hofisattendance.onrender.com'),
                ),
                ActionChip(
